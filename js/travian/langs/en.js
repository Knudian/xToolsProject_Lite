...
Travian.txt["InGameHelp.Village_Rubble.Step1"] = "Every time you demolish a building via the Main Building menu or whenever one is destroyed by attacks, a pile of rubble will be left behind for you to collect.";
...
Travian.txt["Building.Description_3"] = "Miners gather the precious resource of iron at the Iron Mine. By upgrading the level of the Iron Mine, you increase the iron production.";
...
Travian.txt["Troop.Description_11"] = "Clubswingers are the cheapest unit in all of Travian. They are quickly trained and have medium attack capabilities, but their low defense capabilities make them particularly vulnerable to cavalry units.";
...
Travian.txt["Society.Aim_2_2"] = "We invite you to join our secret society to teach the player  {{targetId,targetName|playerLink}} the meaning of fear!";
...
Travian.txt["RallyPoint.SendTroops.Type_Attack"] = "Attack: Normal – Your troops will focus on killing the enemy's units. The fight will end with a complete loss on one side.";
...
Travian.txt["RallyPoint.SendTroops.Type_Raid"] = "Attack: Raid – Your troops will focus on stealing resources, while losing as few units as possible.";
...
Travian.txt["ContextMenu.button.foundVillage"] = "Settle – To settle a village you need 3 settlers. They can be trained in the Palace or Residence.";
...
Travian.txt["CellDetails.IncomingAttack"] = "Incoming attack in: {{time|countdown}}";
...
Travian.txt["Units.Build.Tooltip.unitTime"] = "Completion of this unit {{time|countdown}}";
...
Travian.txt["Error.HelpCenterError"] = "The requested game world is not supported by the Help Center.";
...
Travian.txt["Embassy.Communities.Alliance.HaveToLeaveAlliance"] = "As king, you can found your own alliance, however, you first have to leave your current alliance.";
...
Travian.txt["Chat.BannedFromMessaging.Tooltip.Infinite"] = "You have been indefinite ban from using the messaging system.";
...
Travian.txt.CelebrationEndTime = "Celebration ends in {{time|countdown}}";
Travian.txt.celebrationDescription_1 = "The small celebration - as soon as it starts -  rewards you with {{culturePoints}} culture points. It keeps the Town Hall occupied for {{duration|HHMMSS}} hours. Upgrading the building will reduce the duration of celebrations.{{b|r}}{{b|r}}You will be rewarded with culture points equal to your village's production up to a maximum of 500 culture points.";
Travian.txt.celebrationDescription_2 = "The large celebration - as soon as it starts -  rewards you with {{culturePoints}} culture points. It keeps the Town Hall occupied for {{duration|HHMMSS}} hours. Upgrading the building will reduce the duration of celebrations.{{b|r}}{{b|r}}You will be rewarded with a maximum of 2,000 culture points or the sum of your villages' culture point production.";
...
Travian.txt["Manual.MiscDescription_Siege"] = "Siege is a type of attack whereby troops take twice as long to travel but receive a bonus of {{33|percent}} to their attacking power (multiplied with other bonuses). For this, the attacker needs to send at least 1,000 troops with at least one Ram among them. Apart from that, the siege is similar to a normal attack.";
...
Travian.txt["Payment.SpendGold.Others.Description"] = "[b]Master builder slot[/b] and [b]additional merchant repeat delivery[/b] require a Travian Plus Account to be unlocked once, they will then however remain active for the whole game round.";
...
Travian.txt["Intro.Step_3"] = "But civil war is brewing in Rome, and the barbarian tribes are on the march. A race is on to secure Travian’s vital resources...";
Travian.txt["Intro.Step_4"] = "... creating endless opportunities for a wily strategist like me. And so I’ve come to a small village in need of my services...";
Travian.txt["Intro.Step_5"] = "... only to find it deserted. Well, not quite deserted…";
...
Travian.txt["PlayerLocked.description.rulesReferring"] = "Below is a link to the Game rules for your reference.  Understanding these rules is an important aspect of playing Travian.  Please read them carefully to avoid issues in the future.";
...
Travian.txt["PlayerLocked.description.keepInMind2"] = "Multihunters have the ability to review detailed information about all avatars in Travian.  Be sure you explain only the truthful facts regarding the violation.";
...
Travian.txt.Connection_Loss_NoConnectionAvailable = "No net connection is available at the moment. Attempting to reconnect to the game server…";
